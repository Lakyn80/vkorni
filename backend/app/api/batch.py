...
from app.api.deps import is_probable_person_name, json_response, validate_person_name
...
def create_batch(payload: BatchRequest):
    normalized_names = [validate_person_name(n) for n in payload.names if n and n.strip()]
